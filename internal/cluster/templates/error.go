...
const (
	/* Error Log Templates */
	MasterSlaveMapNotInit    = "promoteToMaster() - Master Slave Map is not set up"
	BothMasterSlaveDead      = "promoteToMaster() : Both Master and Slave are dead"
	...
	NoHashRangeIsAssigned    = "distributeHashSlot() : No Hash Range is assigned to Node(%s)"
